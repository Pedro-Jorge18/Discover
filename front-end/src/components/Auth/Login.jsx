      ...
      {show2FAPopup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-xl p-6 max-w-sm w-full text-center shadow-2xl">
            <h4 className="text-gray-900 font-semibold mb-4 text-lg">{t('auth.authCodeTitle')}</h4>
            <input
              type="text"
              ...
              className="w-full mb-3 px-3 py-2 rounded-lg bg-white text-gray-900 border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 outline-none"
            />
            <button
