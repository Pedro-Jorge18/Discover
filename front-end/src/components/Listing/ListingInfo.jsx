  ...
  return (
    <div className="lg:col-span-2">
      <div className="border-b border-gray-100 pb-10 mb-10">
        <h2 className="text-3xl font-black text-gray-900 italic">{t('property.spaceIn', { city: city || 'Portugal' })}</h2>
      ...
      <div className="mb-12">
        <h3 className="text-xl font-black mb-6 uppercase italic underline decoration-blue-500 decoration-[6px] underline-offset-8">{t('property.aboutThisSpace')}</h3>
