    ...
    <div className="min-h-screen bg-white text-left">
      ...
      <main className="max-w-[1790px] mx-auto px-5 sm:px-10 pt-44 pb-20">
        <div className="flex items-center gap-4 mb-12">
          ...
          <h1 className="text-4xl font-black italic uppercase tracking-tighter text-gray-900">{t('favorites.title')}</h1>
        </div>
        {favorites.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">{t('favorites.noFavorites')}</h2>
            <button onClick={() => navigate('/')} className="mt-8 bg-blue-600 text-white px-8 py-3 rounded-full font-black uppercase italic tracking-tighter shadow-lg shadow-blue-100">{t('favorites.explore')}</button>
          </div>
        )}
      </main>
      <Footer />
